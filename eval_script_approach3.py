...
OUTPUT_TRAINED_FOLDER = "approach_3"

def eval_gp(gp_id, cls):
    # Input data
    if cls:
        EVAL_FOLDER = "approach_3_cls"
        gp_eval_path = f"json_folder/okvqa_train_jsons_approach3/gp{gp_id}_val_cls_10.json"
    else:
        EVAL_FOLDER = "approach_3_ground_truth"
        gp_eval_path = f"json_folder/okvqa_train_jsons_approach3/gp{gp_id}_val_10.json"
